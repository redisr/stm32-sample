##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [2.27.0] date: [Wed May 16 16:48:46 BRT 2018] 
##########################################################################################################################
...
flash:
	openocd -f /usr/local/share/openocd/scripts/board/stm32f334discovery.cfg -c "program $(BUILD_DIR)/$(TARGET).elf reset exit" -c "shutdown"
